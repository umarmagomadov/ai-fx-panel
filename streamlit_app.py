...
# ---------- UI ----------
st.set_page_config(page_title="AI FX Multi Panel PRO+", layout="wide")
st.title("🤖 AI FX Multi Panel PRO+ 🔔📳")
st.caption("RSI + MACD + EMA + Bollinger · Автообновление 10 сек · Звук + вибрация при новом сигнале")
